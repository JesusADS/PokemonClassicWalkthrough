> [← Previous](11-postgame-team-rocket-and-rematches.md) · [Main index](../README.md) · [How to use](../HOW-TO-USE-THE-GUIDE.md)

[English] · [Español](../../es/guia/12-megaevolucion-y-completado-100.md)
...
**Mega Evolution and 100% completion guide**
...
- When choosing a move a gray Mega symbol appears. Press START to turn it into a rainbow symbol and confirm the attack.

- The transformation lasts until the Pokémon is weakened or the battle ends.
...
*Rock Tunnel, one of the plants with access to B1F.*

<img src="../../images/volumen-12/media/image2.png" style="max-width:100%;height:auto" />

*Rock Tunnel, second floor of the tour.*

## Step-by-step walkthrough

1. Start at Viridian Forest and collect Beedrillite.
...
6. Fly to Lavender Town and climb to 6F from Pokémon Tower for Gengarite.
...
# Mega Stone Route: South and West Kanto

| **🎯 OBJECTIVE** |
|---------------------------------------------------------------------|
| Collect the stones Safari Zone, Seafoam Islands and Pokémon Mansion. |
...
7. Fly to Fuchsia City and enter Safari Zone.

8. In the Center area collect Pinsirita.
...
12. Pick up Charizardite X on 2F and Charizardite Y on 3F.
...
| **🎯 OBJECTIVE** |
|---------------------------------------|
| Get Alakazita and the two Mewtwonites. |

<img src="../../images/volumen-12/media/image7.png" style="max-width:100%;height:auto" />

*Cerulean Cave 2F, where both Mewtwonites appear.*

## Step-by-step walkthrough

13. In Saffron City visit Mr. Psychic's house to receive Alakazite.

14. Fly to Cerulean City and enter Cerulean Cave again.

15. Go to the second floor.

16. Pick up Mewtwonite X and Mewtwonite Y, which are now available.

17. Equip the corresponding stone to Mewtwo depending on the form you want to use.

## 💎 Important objects

| **Item** | **Location** | **Priority** |
|--------------|---------------|---------------|
| Alakazite | Mr. Psychic's House | Mega |
| Mewtwonite X | Cerulean Cave 2F | Mega |
| Mewtwonite Y | Cerulean Cave 2F | Mega |
...
| **Pokémon** | **Location** | **State** |
|-------------|-------------------------------------|------------|
| Articuno | Seafoam Islands B4F | ☐ |
| Zapdos | Power Plant | ☐ |
| Moltres | Side Cave by Victory Road | ☐ |
| Mewtwo | Cerulean Cave B1F | ☐ |
| Mew | Faraway Island via Old Sea Map | ☐ |

## Unique Pokémon and gifts
| **Pokémon / gift** | **Location or condition** | **State** |
|-----------------------|---------------------------------------------------|------------|
| Bulbasaur | Berry Backyard by Cerulean City with high friendship | ☐ |
| Charmander | Route 24, static meeting | ☐ |
| Squirtle | Rare encounter in Seafoam Islands according to the guide | ☐ |
| Lapras | Silph Co.                                        | ☐ |
| Hitmonlee | Saffron City Dojo | ☐ |
| Hitmonchan | Saffron City Dojo | ☐ |
| Aerodactyl | Reviving Old Amber | ☐ |
| Omanyte / Kabuto | Selected fossil | ☐ |

## Items and completion functions

| **Element** | **How ​​to get it** | **State** |
|--------------------------|---------------------------|------------|
...
| Master Ball daily | Silph President | ☐ |

## Checklist

**☐** Capture all five legendary/mythical

**☐** Get all the mega stones

**☐** Complete the second Rocket story
...
**☐** Complete Erin and Kairi events
...
| **END OF MAIN GUIDE** |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| These objectives cover all the story, post-game, legendaries, Mega Evolution and extra activities content that the original guide documents with sufficient clarity. |

---

> [← Previous](11-postgame-team-rocket-and-rematches.md) · [General index](../README.md) · [How to use](../HOW-TO-USE-THE-GUIDE.md) · [Next →](../README.md)
