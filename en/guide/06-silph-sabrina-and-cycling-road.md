> [← Previous](05-pokemon-tower-koga-and-safari-zone.md) · [Main index](../README.md) · [How to use](../HOW-TO-USE-THE-GUIDE.md) · [Next →](07-seafoam-islands-articuno-and-blaine.md)

[English] · [Español](../../es/guia/06-silph-sabrina-y-ruta-ciclista.md)
...
**Cycling Road, Saffron City and Silph Co.**
...
*Town Map of Route 16.*

| **🎯 OBJECTIVE** Obtain Fly, wake up the second Snorlax and access Cycling Road. |
|------------------------------------------------------------------------------------------|

## Recommended route

1. Enter from Celadon City and use the Poké Flute in front of the second Snorlax. Save before if you want to capture it.

2. Cross the cuttable tree and enter the isolated house to receive the Fly HM.

3. Talk to the berry NPC south of the house daily.

4. After the fifth Badge, visit Cedar on the second floor of the post to receive the Amulet Coin.

5. Defeat the trainers and enter Route 17 with a bike.

## ⭐ Pokémon and recommended catches

| **Pokémon / group** | **Availability** | **Value for adventure** |
|---------------------|------|-----------------------------------------------|
| Snorlax | Static encounter | High priority if you did not capture the one on Route 12 |
| Doduo | 5-20% | Good physical Flying Pokémon |
| Muk | 1-4% at night | Rare and resistant |

## 💎 Items and rewards

| **Item** | **Where / how** | **Priority** |
|----------------|------------------------------------------------|---------------|
| HM Fly | Isolated house | Mandatory |
| Random Berry | Daily NPC | Low |
| Amulet Coin | Cedar, 2F, after the fifth Badge | Very high |
...
- [ ] Solve the Snorlax encounter

# Route 17 · Cycling Road

<img src="../../images/volumen-06/media/image2.png" style="max-width:100%;height:auto" />

*Town Map of Route 17 and Cycling Road.*

| **🎯 OBJECTIVE** Descend the Cycling Road collecting all the hidden objects. |
|----------------------------------------------------------------------------------|

## Recommended route

6. Enter on a bicycle; the slope pushes you south.

7. DexNav does not work on this route, so captures depend on normal encounters.

8. Stop in the margins to look for hidden Restore All, Max PP, Rare Candy, Max Revive, and Elixir.

9. Defeat the ten bikers before reaching Route 18.

## ⭐ Pokémon and recommended catches

| **Pokémon / group** | **Availability** | **Value for adventure** |
|---------------------|------|----------------------------|
| Ponyta | 4-10% day | Good option Fire |
| Dodrio | 1-4% of day | Strong Flying Attacker |
| Eevee | 1% day | Very rare |
| Muk | 1-4% at night | Rare |

## 💎 Items and rewards

| **Item** | **Where / how** | **Priority** |
|----------------|------------------|---------------|
| Restore All | 🔍 Hidden | High |
| PP Max.        | 🔍 Hidden | High |
| Rare Candy | 🔍 Hidden | High |
| Maximum Revive | 🔍 Hidden | High |
| Elixir | 🔍 Hidden | Medium |
...
- [ ] Find the five hidden objects

- [ ] Defeat the ten bikers

# Route 18

<img src="../../images/volumen-06/media/image3.png" style="max-width:100%;height:auto" />

*Town Map of Route 18.*

| **🎯 OBJECTIVE** Complete the output of the Cycling Road and connect with Fuchsia City. |
|---------------------------------------------------------------------------------------|

## Recommended route

10. Scour the grass if you're looking for Lickitung or Scyther.
11. Defeat the three Birdkeepers.

12. Cross the checkpoint to Fuchsia City.

13. Use Fly to return to Celadon City or Lavender and enter Saffron City for a guard post.

## ⭐ Pokémon and recommended catches

| **Pokémon / group** | **Availability** | **Value for adventure** |
|---------------------|------|----------------------------|
| Lickitung | 1% day/night | Very rare |
| Scyther | By day | Valuable catch |
| Doduo | 1-4% | Optional |
| Muk | 4-10% | Resistant |
...
- [ ] Defeat all three trainers

- [ ] Open fast travel with Fly

# Saffron City and Dojo Karate

<img src="../../images/volumen-06/media/image4.png" style="max-width:100%;height:auto" />

*Town Map from Saffron City.*

| **🎯 OBJECTIVE** Explore the city, overcome the dojo and prepare for the assault on Silph Co. |
|------------------------------------------------------------------------------------------|

## Recommended route

14. Enter Saffron City through any of the guard posts.

15. Visit Mr. Psychic's house and record his location for the post-game Alakazamite.

16. Buy Agua Fresca and enter the Karate Dojo.

17. Defeat their trainers; water allows you to restore your equipment to repeat combats as EV training.

18. After proving your worth, receive Hitmonlee and Hitmonchan.

19. Next enter Silph Co., occupied by Team Rocket.

## ⭐ Pokémon and recommended catches

| **Pokémon / group** | **Availability** | **Value for adventure** |
|---------------------|------|----------------------------------------------|
| Hitmonlee | Dojo Gift | Fast physical attacker |
| Hitmonchan | Dojo Gift | More versatile; the game allows you to obtain both |

## 💎 Items and rewards

| **Item** | **Where / how** | **Priority** |
|-------------------------|---------------------------------------------|---------------|
| Hitmonlee and Hitmonchan | Dojo Reward | High |
| Alakazamite | House of Mr. Psychic, after the second Champion | Postgame |

| **DOJO AND EV** The guide indicates that the Dojo can be used to train EVs; Bring Agua Fresca to restore your trainers. |
|-------------------------------------------------------------------------------------------------------------------------------------------------|
...
- [ ] Receive Hitmonlee and Hitmonchan

- [ ] Prepare cures for Silph Co.
...
| **🎯 OBJECTIVE** Get the Magnetic Key, free the building and defeat Giovanni. |
|------------------------------------------------------------------------------------------|

## Recommended route

20. Explore the lower floors first to collect items and experience.

21. On the fifth floor collect the Magnetic Key; opens the electronic doors of the entire building.

22. Visit the second floor for Thunder Wave's tutor.

23. On the seventh floor, defeat the rival and receive Lapras from the employee.

24. Use the teleportation panels to reach the upper floors.

25. On the eleventh floor defeat Jessie and James and then Giovanni.

26. Talk to the president to receive the Master Ball.

## ⭐ Pokémon and recommended catches

| **Pokémon / group** | **Availability** | **Value for adventure** |
|---------------------|------|---------------------------------------|
| Lapras | Gift, 7F | Top Priority: Excellent Water/Ice |

## 💎 Items and rewards

| **Item** | **Where / how** | **Priority** |
|---------------------------------------------------------------|------------------|------------------|
| Ultra Ball | 🔍 Hidden, 2F | Medium |
| Protein/Hyper Potion | 3F | Medium |
| Iron / TM41 / Full Cure / Escape Rope / Maximum Revive | 4F | High |
| Protein / Elixir / Magnetic Key / TM01 | 5F | Very high |
| Fuel / More PS / Special X | 6F | Medium |
| TM08 / Zinc / Calcium | 7F | High |
| Nugget / Iron | 8F | Medium |
| Calcium / Max Potion | 9F | High |
| More PS / Fuel / Rare Candy / Ultra Ball | 10F | High |
| Zinc / Revive / Master Ball | 11F | Maximum priority |
...
| **ESSENTIAL GIFT** Lapras is one of the best Pokémon for the final stretch and the League. |
|---------------------------------------------------------------------------------------------|
...
- [ ] Defeat the rival, Jessie and James and Giovanni
...
| **ADDITIONAL REWARD** After the sixth Badge, return to the Route 15 checkpoint and talk to Cedar to receive the Exp. Share |
|-------------------------------------------------------------------------------------------------------------------------------------------------|

| **NEXT VOLUME** The next section will lead to the sea routes, Seafoam Islands, Cinnabar Island, Pokémon Mansion and Blaine's gym. |
|---------------------------------------------------------------------------------------------------------------------------------------------|

---

> [← Previous](05-pokemon-tower-koga-and-safari-zone.md) · [General index](../README.md) · [How to use](../HOW-TO-USE-THE-GUIDE.md) · [Next →](07-seafoam-islands-articuno-and-blaine.md)
