> [← Previous](08-giovanni.md) · [Main index](../README.md) · [How to use](../HOW-TO-USE-THE-GUIDE.md) · [Next →](10-postgame-zapdos-mewtwo-and-mew.md)

[English] · [Español](../../es/guia/09-calle-victoria-y-liga.md)
...
*Town Map of Route 22.*

| **🎯 OBJECTIVE** Overcome the last mandatory fight against the rival and head to the League. |
|------------------------------------------------------------------------------------------|

## Recommended route

1. Heal the team before exiting Viridian City to the west.

2. If you skipped the optional combat at the start of the game, the final evolution of your opponent's Eevee may vary.
...
|---------------------|------|--------------------------------------|
| Nidoran♀ / Nidoran♂ | 5-20% | They no longer usually improve the final team |
| Mankey | 10% day | Optional |
| Slowbro / Golduck | Surf, rare | Optional |
...
| Slowbro | 🏄 Surf | Day, 1-5% |
| Psyduck | 🏄 Surf | Night, 30-60% |
| Golduck | 🏄 Surf | Night, 1-5% |
...
*Town Map of Route 23 and Badge controls.*

| **🎯 OBJECTIVE** Go through the Badge checkpoints and collect the hidden objects before Victory Road. |
|----------------------------------------------------------------------------------------------------------|

## Recommended route

5. Move through the checkpoints; each guard checks a different Badge.

6. Look for the berries and hidden objects on both sides of the path.

7. Pick up the TM10 in the visible Great Ball.

8. Explore the water if you want to try to get Dratini with the Super Rod.

9. Enter Victory Road with Strength, Surf and enough heals.

## ⭐ Pokémon and recommended catches

| **Pokémon / group** | **Availability** | **Value for adventure** |
|---------------------------|---------------------------|---------------------------|
| Primeape / Arbok / Sandslash | 1-4% depending on time | Optional |
| Ditto | 10-20% | Useful for parenting |
| Dratini | 1-4% with Super Rod during the day | Very rare |
| Gyarados | 15% with Super Rod during the day | Powerful if you don't have one yet |
...
| Goldeen | 🎣 Good Rod | Day, 20-60%; night, 20% |
| Poliwag | 🎣 Good Rod | Day, 20%; night, 20-60% |
| Seaking | 🎣 Super Rod | Day, 40% |
| Poliwhirl | 🎣 Super Rod | Night, 40% |
| Gyarados | 🎣 Super Rod | Day, 15% |
| Dratini | 🎣 Super Rod | Day, 1-4% |

## 💎 Items and rewards

| **Item** | **Where / how** | **Priority** |
|----------------|------------------|---------------|
| Leppa Berry | 🔍 Hidden | High |
| Ether Max.      | 🔍 Hidden | High |
| Aspear Berry | 🔍 Hidden | Medium |
| Restore All | 🔍 Hidden | Very high |
| Zidra Berry | 🔍 Hidden | High |
| Ziuela Berry | 🔍 Hidden | Very high |
| Elixir Max.    | 🔍 Hidden | Very high |
| TM10 | Great Ball | High |

## ⚠ Before continuing

- [ ] Collect Restore All and Elixir Max.

- [ ] Collect TM10

- [ ] Enter with Strength and many cures
...
| **🎯 OBJECTIVE** Solve the rock puzzles, capture Moltres and reach the Indigo Plateau. |
|------------------------------------------------------------------------------------------|

## Recommended route

10. Push the rocks with Strength onto the switches to open the steps.

11. Explore each floor before going up: there are several TMs and hidden objects.

12. In the side cave save before facing Moltres.

13. Pick up the Power Stone in 3F and the TM50 before leaving.

14. Talk to Double-Edge's tutor in 2F if you're interested in movement.

15. Exit the northern end towards the Indigo Plateau.

## ⭐ Pokémon and recommended catches

| **Pokémon / group** | **Availability** | **Value for adventure** |
|---------------------|------|----------------------------|
| Machoke / Graveler | 20% | Common and useful |
| Onix | 1-10% / Rock Smash | Optional |
| Sandslash | Rock Smash | Rare |
| Moltres | Static encounter | Legendary; high priority |

## 💎 Items and rewards

| **Item** | **Where / how** | **Priority** |
|---------------------|------------------|---------------|
| Heat Rock | Moltres Cave | High |
| Ultra Ball | 🔍 Hidden, 1F | High |
| Restore All | 🔍 Hidden, 1F | Very high |
| TM02 | 1F | Very high |
| TM37 | 2F | High |
| Total Cure | 2F | Medium |
| TM07 | 2F | High |
| Special Protection | 2F | Medium |
| Power Stone | 3F | Very high |
| Max Revive        | 3F | Very high |
| TM50 | 3F | Very high |
...
| **NOTE FROM SOURCE** The original guide leaves it pending to confirm whether Ray and Tyra form a double combat; that warning is preserved. |
|---------------------------------------------------------------------------------------------------------------------------------------------|

## ⚠ Before continuing

- [ ] Capture or defeat Moltres

- [ ] Collect Power Stone, TM02 and TM50
...
*Exterior of the Indigo Plateau.*

| **🎯 OBJECTIVE** Prepare the equipment and buy everything you need before Elite Four. |
|----------------------------------------------------------------------------------|

## Recommended route

16. Activate the Pokémon Center and heal the team.

17. Buy Restore All, Revive, Ultimate Potion, and status cures.
...
| **Item** | **Where / how** | **Priority** |
|--------------|----------------------------------------|---------------|
| Red Card | Cueball Punk, exterior of Battle Tower | Optional |

| **RECOMMENDED TEAM** A combination of Water/Ice, Electric, Psychic, Earth/Rock, and a strong physical attacker covers most of the League. |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **SUPPLIES** Buy more than you think necessary: ​​the five battles are done in a row. |
|------------------------------------------------------------------------------------------------|
...
- [ ] Ice and Electric Moves available
...
- Electric attacks are the most consistent solution against four members.

- Cloyster has very high Physical Defense; use special attacks.

- Slowbro can become dangerous if he accumulates upgrades: prioritize it.

- Jynx is physically fragile, but can sleep or freeze.
...
- Opens with a strong Electric attack against Gyarados.

- Reserve Ice Beam or Blizzard for Dragonair and Dragonite.
...
| **LEVEL CAP FINAL** 65. Eevee's evolution depends on your first two fights against the rival. |
|----------------------------------------------------------------------------------------------------------|
...
- Identify Eevee's evolution before entering and save its direct counter for the end.

- Use Water or Ice against Sandslash.
...
> [← Previous](08-giovanni.md) · [General index](../README.md) · [How to use](../HOW-TO-USE-THE-GUIDE.md) · [Next →](10-postgame-zapdos-mewtwo-and-mew.md)
