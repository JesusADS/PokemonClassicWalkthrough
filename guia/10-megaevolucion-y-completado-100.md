...
| **REQUISITO**                                                                                                            |
|--------------------------------------------------------------------------------------------------------------------------|
| Vence por segunda vez al Alto Mando y al Campeón y consigue el Mega Ring. Las megapiedras aparecen después de este hito. |
...
| **Megapiedra** | **Localización**                         | **Condición**                                 |
|----------------|------------------------------------------|-----------------------------------------------|
| Venusaurita    | Ciudad Celeste                           | Invisible en Berry Backyard tras segunda Liga |
| Charizardita X | Mansión Pokémon 2F                       | Objeto de posjuego                            |
| Charizardita Y | Mansión Pokémon 3F                       | Objeto de posjuego                            |
| Blastoisinita  | Mt. Moon 6F                              | Invisible tras segunda Liga                   |
| Beedrillita    | Bosque Verde                             | Objeto de posjuego                            |
| Pidgeotita     | Ruta 2                                   | Disponible tras segunda Liga                  |
| Alakazita      | Casa de Mr. Psychic, Ciudad Azafrán      | Tras segunda Liga                             |
| Slowbronita    | Zona indicada por la guía en el posjuego | Tras derrotar al Campeón 2                    |
| Gengarita      | Torre Pokémon 6F                         | Tras segunda Liga                             |
| Kangaskhanita  | Zona Safari Este                         | Objeto de posjuego                            |
| Pinsirita      | Zona Safari Centro                       | Objeto de posjuego                            |
| Gyaradosita    | Islas Espuma                             | Tras segunda Liga                             |
| Aerodactylita  | Túnel Roca B1F                           | Tras segunda Liga                             |
| Mewtwonita Y   | Cueva Celeste 2F                         | Tras segunda Liga                             |
| Mewtwonita X   | Cueva Celeste 2F                         | Tras segunda Liga                             |

| **NOTA SOBRE SLOWBRONITA**                                                                                                                                                                                     |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| La guía confirma que existe en el posjuego después de la segunda victoria, pero el fragmento de documentación disponible no identifica con claridad el mapa concreto. No se inventa una ubicación más precisa. |
...
3.  Vuela a Ciudad Celeste y examina Berry Backyard para Venusaurita, que es invisible.

4.  Ve a Mt. Moon y alcanza 6F para Blastoisinita.
...
| Venusaurita   | Ciudad Celeste, invisible | Mega          |
| Blastoisinita | Mt. Moon 6F, invisible    | Mega          |
...
10. Viaja a Islas Espuma y busca Gyaradosita.
...
| Mega Ring                | Segunda victoria de Liga      | ☐          |
| DexNAV                   | Casa de Bill                  | ☐          |
