...
1.  Vuelve a Ciudad Azafrán y entra en Silph S.A.

2.  La guía señala una “Second Rocket Take-over” en el posjuego.

3.  En 1F aparecen tres Rocket Grunts adicionales y en 3F otro Rocket Grunt de posjuego.

4.  Avanza por el edificio utilizando los ascensores y paneles de teletransporte que ya conoces.

5.  Derrota al Postgame Rocket Leader.

6.  Después podrás enfrentarte al presidente de Silph en un combate que otorga Battle Points y admite rematch.
...
**☐** Completar la segunda toma

**☐** Derrotar al líder Rocket

**☐** Desbloquear el rematch del presidente

**☐** Recoger la recompensa diaria cuando corresponda
...
- Usa los puntos en la Battle Tower, que en esta versión funciona principalmente como tienda.

- La FAQ de la guía indica que en el posjuego puedes comprar con Battle Points un objeto que maximiza los IV.

## Checklist

**☐** Completar cada rematch al menos una vez

**☐** Anotar qué combates se reinician diariamente

**☐** Ahorrar Battle Points para el objeto de IV
...
8.  Ve al exterior de la Meseta Añil y entra en la zona de Battle Tower.

9.  Recoge la Red Card del Cueball Punk si no la obtuviste antes.

10. La torre original está rota y no pudo repararse; Pokémon Classic la reutiliza como una tienda para gastar Battle Points.

11. Revisa todos los vendedores y compara los precios antes de gastar.

12. Prioriza el objeto de posjuego que maximiza IV si buscas optimizar a tu equipo.
...
| **Objeto**               | **Localización**        | **Prioridad** |
|--------------------------|-------------------------|---------------|
| Red Card                 | Cueball Punk, exterior  | Opcional      |
| Objeto para maximizar IV | Tienda de Battle Points | Muy alta      |

| **LIMITACIÓN DE LA FUENTE**                                                                                        |
|--------------------------------------------------------------------------------------------------------------------|
| No se documenta una lista completa de productos o precios. Este volumen no rellena esos huecos con datos externos. |

## Checklist

**☐** Visitar todos los vendedores

**☐** Comprar la mejora de IV cuando tengas puntos

**☐** Conservar puntos para objetos raros

# Rocket Fugitives: ruta diaria

| **MISIÓN DIARIA**                                                                                                                                                       |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| La guía describe una misión diaria para localizar fugitivos Rocket. Muchos mapas indican posibles puntos de aparición; la selección concreta puede variar según el día. |

| **Zona**                  | **Pista de la guía**                           |
|---------------------------|------------------------------------------------|
| Ruta 1                    | Cerca de la salida hacia Ciudad Verde          |
| Ruta 2                    | Al norte de la entrada de Cueva Diglett        |
| Ruta 2                    | Cerca de la baya Ziuela/Lum                    |
| Ciudad Plateada           | Junto al museo, esquina superior derecha       |
| Ruta 4                    | En la hierba                                   |
| Ruta 4                    | Cerca de Cueva Celeste                         |
| Ruta 5                    | Hierba sobre la Guardería                      |
| Ruta 6                    | Parche de bayas superior derecho               |
| Ruta 7                    | Localización indicada como evento de posjuego  |
| Ruta 8                    | Localización indicada como evento de posjuego  |
| Ciudad Carmín / S.S. Anne | Evento Rocket Fugitive                         |
| Cueva Diglett             | Dentro de la cueva                             |
| Ciudad Azulona            | A la derecha del Centro Pokémon, entre árboles |
| Ruta 10                   | Localización de posjuego indicada en la ruta   |
| Ruta 11                   | Evento de posjuego                             |
| Ruta 12                   | Evento de posjuego                             |
| Ruta 13                   | Evento de posjuego                             |
| Ruta 14                   | Evento de posjuego                             |
| Ruta 15                   | Evento de posjuego                             |
| Ruta 16                   | Evento de posjuego                             |
| Ruta 17                   | Evento de posjuego                             |
| Ruta 18                   | Evento de posjuego                             |
| Ruta 19                   | Evento de posjuego                             |
| Ruta 20                   | Evento de posjuego                             |
| Ruta 21 norte             | Evento de posjuego                             |
| Ruta 21 sur               | Evento de posjuego                             |
| Ruta 22                   | Evento de posjuego                             |

- Habla con los NPC relacionados con la misión para saber si hay un objetivo activo.

- Usa Vuelo para revisar primero ciudades y puntos cercanos a Centros Pokémon.

- Recorre después las rutas cortas y deja para el final las cuevas o rutas acuáticas.

- La guía no especifica en todos los casos el punto exacto, la frecuencia ni la recompensa; se conserva la redacción disponible.

## Checklist

**☐** Revisar los puntos urbanos

**☐** Revisar rutas 1-8

**☐** Revisar rutas 10-18

**☐** Revisar rutas acuáticas 19-21
...
14. Visita la casa de Cooltrainer Erin en Bosque Verde y habla con ella durante el posjuego.

15. Regresa al Dojo Karate de Ciudad Azafrán: sirve para entrenamiento de EV y permite demostrar tu valía para obtener Hitmonchan y Hitmonlee. Lleva Fresh Water para restaurar al equipo de entrenadores.

16. Consulta los tutores de movimiento de la segunda planta de los Centros Pokémon y los tutores de campo que dejaste pendientes.

17. Repite el combate del presidente de Silph para la recompensa diaria cuando esté disponible.

18. Revisa a Lass Kairi en Faraway Island después de haber capturado el encuentro de la isla y completado el primer campeonato.
...
| **Objeto**             | **Localización**                            | **Prioridad**     |
|------------------------|---------------------------------------------|-------------------|
| Hitmonchan y Hitmonlee | Dojo de Ciudad Azafrán                      | Regalos / desafío |
| Fresh Water            | Necesaria para restaurar al equipo del Dojo | Utilidad          |
| Master Ball diaria     | Presidente de Silph                         | Repetible         |
...
**☐** Completar evento de Erin

**☐** Conseguir ambos Hitmon

**☐** Revisar tutores pendientes
